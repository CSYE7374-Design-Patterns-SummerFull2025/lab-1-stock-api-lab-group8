...
public class NetflixStock extends Stock implements Tradeable1 {
    private double priceFactor;

    public NetflixStock(String name, double price, String description, double priceFactor) {
    ...
    public String calculateMetric() {
        ...
        double peRatio = getPrice() / priceFactor;
